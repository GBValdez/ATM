...
public class dataBase {
    ...
    public static void connect() {
        account testUser = account.builder().NIP(12345l).numberAccount(12345l).balance(300f).floatingBalanceM(300f)
                .build();
        account testUser2 = account.builder().NIP(11111l).numberAccount(22222l).balance(50f).floatingBalanceM(300f)
                .build();
        data.add(testUser);
        data.add(testUser2);
